#ifndef RKANOID_GBA_REGS_H
#define RKANOID_GBA_REGS_H

#define DISPCNT		*(volatile u32*)0x04000000			//Sets DISPCNT to be the register for it.  Easier than using the hex every time
#define BG0CNT		*(volatile u16*)0x04000008			//Sets BG0CNT to be the register for it.  Easier than using the hex every time
#define BG1CNT     	*(volatile u16*)0x0400000A
#define BG2CNT     	*(volatile u16*)0x0400000C
#define BG3CNT     	*(volatile u16*)0x0400000E

#define DMA3SAD		*(volatile u32*)0x040000d4			//setups up all display variables.  read the official docs for more info
...
#define BG0_DATA    ((volatile u16*)0x6004000)
#define BG_PLTT    ((volatile u16*)0x5000000)

#define VBUFFER    ((volatile u16*)0x6000000)
...
static u16 joypad() 									//joypad checking routine.  
{
	u16 j=P1;
	P1 |= 0x03FF;
	return j;
...
static void DMA3Call(u32 Src,u32 Dst,u32 Cnt)				//used to load our sprite info into vram			
{
...
static void Wait( u32 HowManyVSyncs )
{
	u8 i,j;
	u32 Waiter;
...
static void fade_out(u8 retardo_fin, u8 sprfade, u8 bn)
{
 u8 Phase;
 u8 retardo_ini;
...
static void fade_in(u8 retardo_fin, u8 sprfade, u8 bn)
{
 int Phase;
 u8 retardo_ini;
...
static void Sonido(u16 delay, int sound)
{
