...
void RefrescaLife(u16 num)
{
	...
	OAM[15].Attrib0 = 0x2000+40;		OAM[15].Attrib1 = 192;		OAM[15].Attrib2 = 10+(cadnum[0]*2);
	OAM[16].Attrib0 = 0x2000+40;		OAM[16].Attrib1 = 192+8;	OAM[16].Attrib2 = 10+(cadnum[1]*2);
}
