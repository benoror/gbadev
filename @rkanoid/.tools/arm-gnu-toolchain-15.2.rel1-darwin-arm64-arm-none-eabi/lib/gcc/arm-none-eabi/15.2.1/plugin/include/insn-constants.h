...
enum unspec {
  ...
  VADCQ_U_carry = 1042,
  VADCQ_M_U = 1043,
  VADCQ_M_U_carry = 1044,
  VADCQ_S = 1045,
  VADCQ_S_carry = 1046,
  VADCQ_M_S = 1047,
  VADCQ_M_S_carry = 1048,
  VSBCIQ_U = 1049,
  VSBCIQ_U_carry = 1050,
  VSBCIQ_S = 1051,
  VSBCIQ_S_carry = 1052,
  VSBCIQ_M_U = 1053,
  VSBCIQ_M_U_carry = 1054,
  VSBCIQ_M_S = 1055,
  VSBCIQ_M_S_carry = 1056,
  VSBCQ_U = 1057,
  VSBCQ_U_carry = 1058,
  VSBCQ_S = 1059,
  VSBCQ_S_carry = 1060,
  VSBCQ_M_U = 1061,
  VSBCQ_M_U_carry = 1062,
  VSBCQ_M_S = 1063,
  VSBCQ_M_S_carry = 1064,
  VADCIQ_U = 1065,
  VADCIQ_U_carry = 1066,
  VADCIQ_M_U = 1067,
  VADCIQ_M_U_carry = 1068,
  VADCIQ_S = 1069,
  VADCIQ_S_carry = 1070,
  VADCIQ_M_S = 1071,
  VADCIQ_M_S_carry = 1072,
  VLD2Q = 1073,
  VLD4Q = 1074,
  VST2Q = 1075,
  VSHLCQ_M_U = 1076,
